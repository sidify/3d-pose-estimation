...
tf.app.flags.DEFINE_boolean("add_kinematics", True, "Train with augmented translated 3d data.")
tf.app.flags.DEFINE_integer("add_noise", 0, "Train with noisy 3d data.")
...
def train():
  ...
  if FLAGS.use_sh:
    ...
    train_set_2d, test_set_2d, data_mean_2d, data_std_2d, dim_to_ignore_2d, dim_to_use_2d, train_set_2d_for_noisy, data_mean_2d_test, data_std_2d_test = data_utils.create_2d_data( actions, FLAGS.data_dir, rcams, augmented3d )
      ...
      if FLAGS.evaluateActionWise:
        ...
        for action in actions:
          ...
          act_err, _, step_time, loss = evaluate_batches( sess, model,
            data_mean_3d_test, data_std_3d_test, dim_to_use_3d, dim_to_ignore_3d,
            data_mean_2d_test, data_std_2d_test, dim_to_use_2d, dim_to_ignore_2d,
