...
def create_2d_data( actions, data_dir, rcams, augmented3d=None ):
  ...
  print(data_std)
  return train_set, test_set, data_mean, data_std, dim_to_ignore, dim_to_use, train_set_2d_for_noisy
...
def read_3d_data( actions, data_dir, camera_frame, rcams, predict_14=False, augment_all=False, augment_rot=False, augment_flip=False, augment_trans=False, noisy=False, add_kinematics=False ):
  ...
  return train_set, test_set, data_mean, data_std, dim_to_ignore, dim_to_use, train_root_positions, test_root_positions, augmented3d, train_set_for_noisy
 ...
 for (sub,act,string),data in tst3d.items():
  ...
  if augment_all == True or augment_flip == True:
    ...
    for frame in data:
      ...
      #viz.plotFlip([frame, flip], connect=True, c=viz.connect_points32())
